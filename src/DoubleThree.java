public class DoubleThree {
    ...
    public boolean doubleThree(int[][] arr, int r, int c, int p){
        ...
        temp = arr;
        temp[r][c] = p;
        if (hor(temp, r, c) || ver(temp, r, c) || diagLft(temp, r, c) || diagRght(temp, r, c))
            return (true);
        return (false);
    }

    //3 in a row
    private boolean hor(int[][] arr, int r, int c){
        int i = 0;
        while (i < 3 && i + c < 19){
            if (c - 2 + i > 0 && c + i < 18) {
    ...
    private boolean ver(int[][] arr, int r, int c){
        int i = 0;
        while (i < 3 && i + r < 19){
            if (r - 2 + i >= 0 && r + i < 19) {
    ...
    private boolean diagLft(int[][] arr, int r, int c){
        int i = 0;
    ...
    private boolean diagRght(int[][] arr, int r, int c){
        int i = 0;
